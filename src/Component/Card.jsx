...
function Card({onClick, ...props}) {
  ...
  return (
    <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:border-gray-700 hover:opacity-80 transition flex flex-col cursor-pointer" onClick={() => onClick(props.id)}>
      <img
