    ...
    <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow hover:opacity-80 transition flex flex-col cursor-pointer" onClick={() => onClick(props.id)}>
      ...
      <div className="p-5 flex flex-col flex-grow">
        ...
        <div className="mt-auto">
          <a
            className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 mt-3" onClick={() => onClick(props.id)}
          >
            Read more
            <svg
